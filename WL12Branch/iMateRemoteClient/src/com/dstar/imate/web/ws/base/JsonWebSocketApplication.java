...
public abstract class JsonWebSocketApplication<T extends JsonWebSocket> extends WebSocketApplication {
	...
	public void onMessage(WebSocket websocket, String data) {
		...
		JsonResponse<? extends IData> resp = isProtocolRequest(jsonRequest) ? processProtocol(ws, jsonRequest)
				: processRequest(jsonRequest);
		resp.setType(jsonRequest.getType());// to callback the same type
