...
import com.dstar.imate.web.json.base.gson.external.bind.JsonRequestDefaultToStringDataDeserializer;
...
public class Json {
	...
	public static void init() {
		if (gson == null) {
			...
			gsonB.excludeFieldsWithoutExposeAnnotation();		// only fields marked with @Expose will only be considered
			...
			gsonB.registerTypeAdapter(JsonRequest.class, JsonRequestDefaultToStringDataDeserializer.FACTORY);
