...
public class CouponServiceTest extends CouponService {
	public CouponServiceTest(CouponManagerFacade manager) {
		super(manager);
	}
	...
	private static CouponManagerFacade doManualInjection() {
		try {
			...
			CouponManager<Coupon> managerRemote = (CouponManager<Coupon>) ctx.lookup("java:global/iMateEAR/iMate/CouponManagerBean");
			return CouponManagerFacade.getInstance(managerRemote);
