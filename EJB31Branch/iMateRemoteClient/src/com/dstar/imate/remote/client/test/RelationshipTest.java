...
public class RelationshipTest {
	...
	public static void main(String[] args) throws Exception {
		...
		RelationshipManager manager = (RelationshipManager)
		// GF //JBOSS 
	...
	private static void find(RelationshipManager manager) {
		ResponseData<UserProfile> found = manager.findProfiles("j", 10);
		System.out.println(found);
	}

	private static void createUser(RelationshipManager manager) {
	...
	private static void fetch(RelationshipManager manager) {
	...
	private static void createGroup(RelationshipManager manager) {
	...
	private static void createRelationship(RelationshipManager manager) {
